...
Measures two things:
  1. Retrieval quality   — did the right source document appear in the top-K results?
...
from rag_utils import get_collection, generate_answer, score_faithfulness, check_hit

embedding_model = SentenceTransformer(EMBEDDING_MODEL)


def retrieve(question: str, collection, k: int) -> tuple[list[str], str]:
    """Embed the question and return (titles, joined context) for the top-K passages."""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--k",               type=int, default=5,
                        help="Top-K passages to retrieve (default: 5)")
    parser.add_argument("--no-faithfulness", action="store_true",
                        help="Skip answer generation and faithfulness scoring (faster)")
